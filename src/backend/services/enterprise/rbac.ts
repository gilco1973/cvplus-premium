...
export class EnterpriseRBACService extends BaseService {
  ...
  async assignRole(
    ...
    try {
      ...
      logger.error(null, { error: (error as Error), userId, tenantId, roleId });
      throw error;
    }
  }
  ...
  async removeRole(
    ...
    try {
      ...
      logger.error(null, { error: (error as Error), userId, tenantId });
      throw error;
    }
  }
  ...
  async checkPermission(check: PermissionCheck): Promise<boolean> {
    try {
      ...
      logger.error(null, { error: (error as Error), check });
  ...
  async createRole(tenantId: string, role: EnterpriseRole, createdBy: string): Promise<void> {
    try {
      ...
      logger.error(null, { error: (error as Error), tenantId, role });
      throw error;
    }
  }
  ...
  async updateRole(
    ...
    try {
      ...
      logger.error(null, { error: (error as Error), tenantId, roleId, updates });
      throw error;
    }
  }
  ...
  async auditUserAccess(
    ...
    try {
      ...
      logger.error(null, { error: (error as Error), userId, tenantId, timeframe });
      throw error;
    }
  }
